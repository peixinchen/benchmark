...
public class SortQuickSortNearlyOrderedAscendBCase extends AbstractSortBCase {
    public SortQuickSortNearlyOrderedAscendBCase() {
        super(SortMethodImpl.getQuickSort(), DistributionMethodImpl.getNearlyOrderedAscend());
    }
}