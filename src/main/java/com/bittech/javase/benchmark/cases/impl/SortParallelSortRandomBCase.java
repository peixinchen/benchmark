...
public class SortParallelSortRandomBCase extends AbstractSortBCase {
    public SortParallelSortRandomBCase() {
        super(SortMethodImpl.getParallelSort(), DistributionMethodImpl.getRandom());
    }
}